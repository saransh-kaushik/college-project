      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="glass-card rounded-[2.5rem] shadow-2xl p-8 md:p-10">
          ...
          <div className="flex p-1 bg-white/50 dark:bg-black/20 rounded-full mb-10 relative">
            <Link to="/login" className="flex-1 text-center py-3 text-sm font-bold rounded-full bg-white dark:bg-white/10 text-primary shadow-sm transition-all duration-300">
              Sign In
            </Link>
            <Link to="/register" className="flex-1 text-center py-3 text-sm font-medium rounded-full text-gray-500 hover:text-gray-900 dark:hover:text-white transition-all duration-300">
              Create Account
            </Link>
          </div>
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm">Enter your credentials to access your AI tutor workspace.</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            <div>
              <div className="flex justify-between items-center mb-2 px-1">
                <label className="text-xs font-bold tracking-widest uppercase text-gray-500" htmlFor="password">Password</label>
          ...
          <div className="relative my-8 text-center">
            ...
            <span className="relative px-4 bg-background-light dark:bg-background-dark text-xs font-bold text-gray-500 uppercase tracking-widest">Or continue with</span>
          </div>
          ...
          <p className="text-center mt-8 text-xs text-gray-500">
            By continuing, you agree to Lumina AI's <a className="text-primary font-bold hover:underline" href="#">Terms</a> &amp; <a className="text-primary font-bold hover:underline" href="#">Privacy Policy</a>.
          </p>
        </div>
        
        {/* Bento Preview Hint */}
        <div className="mt-8 flex justify-center gap-4 animate-pulse">
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/40 dark:bg-white/10 border border-primary/5 text-xs font-medium text-gray-600 dark:text-gray-300">
            <span className="material-symbols-outlined text-sm">verified_user</span>
            Enterprise Grade Security
          </div>
          <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/40 dark:bg-white/10 border border-primary/5 text-xs font-medium text-gray-600 dark:text-gray-300">
            <span className="material-symbols-outlined text-sm">auto_awesome</span>
            GPT-4o Powered Tutor
          </div>
        </div>
      </div>
    </main>
